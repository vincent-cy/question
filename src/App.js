...
function BaseInfoCard(props) {
  ...
  return <Layout>
    ...
    <div style={{padding: 8}} >
      <h1>竞赛规则：</h1>
      <h3>1.答题前正确填写本人姓名、所在单位和手机号码（非安委会成员单位人员填写属地乡镇）。</h3>
      <h3>2.本次竞赛共25道题，每道题4分，总分100分。</h3>
      <h3>3.每人答题1次，多次答题取第1次成绩。</h3>
      <h3>4.答题提交成功的纳入评奖统计，个人信息填写不完整的不予统计。</h3>
      <h3>5.按照先高分后低分的总体规则确定获奖人员，分数相同的经抽奖确定。</h3>
      <h3>6.奖项设置：一等奖1名，奖励天然气热水器一台（价值3000元）；二等奖2名，各奖励天然气灶具一台（价值1500元）三等奖20名，各奖励天然气保险两年（价值100元）。</h3>
      <h3>7.本次活动截止时间为2020年6月30日20:00。</h3>
    </div>
    <Form
      size="large"
      onFinish={onFinish}
